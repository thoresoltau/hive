...
class TestCLI:
    ...
    def test_init_command(self, temp_project):
        ...
        with patch("rich.prompt.Prompt.ask") as mock_ask:
            ...
            assert "Directory infested!" in result.stdout
    ...
    def test_init_existing_fails(self, temp_project):
        ...
        assert "Hive already initialized" in result.stdout

    def test_create_ticket(self, temp_project):
        """Test 'hive hatch' (create-ticket alias)."""
        # Setup env
        ...
        with patch("rich.prompt.Prompt.ask") as mock_ask:
            ...
            with patch("builtins.input", side_effect=["Description line 1", ""]):
                result = runner.invoke(app, ["hatch"])
                ...
                assert result.exit_code == 0
                assert "HIVE-001 created!" in result.stdout
...
""")
    ...
    def test_uninitialized_command_fails(self, temp_project):
        ...
        assert result.exit_code == 1
        assert "No Hive project found" in result.stdout
